...
import { ShieldAlert, Cloud, Scale, AlertTriangle, Info } from 'lucide-react';
                ...
                <div className="h-[200px] w-full relative">
                    <ResponsiveContainer width="100%" height="100%">
                        <AreaChart data={data} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
                            ...
                            {/* Dynamic Line Color based on thresholds isn't native, so we use a safe blue or composite logic. 
                                Ideally we use a gradient or segments, but clear blue is "Standard" until we hit red zones.
                            */}
                            <Area
                                type="monotone"
